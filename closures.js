...
var myLevel = function (argument) {
	return this.time < 30 ? "I need to improve my game" : (this.time >30 && this.time < 100) ? "You need to improve your game" :"Wow, I have wasted a lot of time";
	// if (this.time < 30 ){
